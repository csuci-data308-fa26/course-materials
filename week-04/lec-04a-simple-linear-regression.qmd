...
- *Interpretation in context*: For elephants 0 meters tall we *expect* their mass to be `r round(b0_hat, digits = 2)` kilograms.
...
- *Interpretation in context*: For elephants that differ in height by one meter we *expect* the taller elephants to have a mass`r round(b1_hat, digits = 2)` kilograms more, on average.
...
For elephants 250 meters tall we *expect* their mass to be around `r round(y_hat, digits = 2)` kilograms.

OR

We *predict* 250 meter tall elephants to have a mass of `r round(y_hat, digits = 2)` kilograms, *on average*. 
:::
::::
